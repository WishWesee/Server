        ...
        http
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .permitAll()
                                .requestMatchers(HttpMethod.GET, "/api/v1/invitation/{invitationId}")
                                .permitAll()
                                ...
                                .permitAll()
                                .requestMatchers("/api/v1/invitation/{invitationId}/schedule/check", "/api/v1/invitation/{invitationId}/schedule/guest", "/api/v1/invitation/{invitationId}/schedule")
                                .permitAll().requestMatchers("/api/v1/map/search")
                                .permitAll()
