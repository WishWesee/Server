        ...
        http
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .permitAll()
                                .requestMatchers("/api/v1/invitation", "/api/v1/{invitationId}/attendance/check", "/api/v1/{invitationId}/attendance/guest")
                                .permitAll()
                                .requestMatchers(HttpMethod.GET, "/api/v1/{invitationId}/attendance")
                                .permitAll()
